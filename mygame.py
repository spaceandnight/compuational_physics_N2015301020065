...
textImage3 = myfont1.render("If you get a score of 60, you will win this game.", True, black)
...
while True:
    ...
    if i == 2:
        ...
        for event in pygame.event.get():
            if event.type == MOUSEBUTTONDOWN:
                mouse_dx,mouse_dy = event.pos
                if mouse_dx <= 442 and mouse_dx >= 280 and mouse_dy <= 500 and mouse_dy >= 400:
                    pygame.quit()
                    sys.exit()
                elif mouse_dx <= 632 and mouse_dx >= 520 and mouse_dy <= 500 and mouse_dy >= 400:
                    score = 0
                    am = 240
                    pw = 0
                    i = 1
